package com.testbed.web.api.controller;

import com.testbed.core.domain.testbed.NftMember;
import com.testbed.core.dto.request.NftGalleryRequest;
import com.testbed.web.api.dto.MainPageDto;
import com.testbed.web.api.dto.MemberWalletDto;
import com.testbed.web.api.dto.request.GetNftOneRequest;
import com.testbed.web.api.dto.request.MemberNftRequest;
import com.testbed.web.api.dto.request.UpdateLikeCountRequest;
import com.testbed.web.api.dto.request.UpdateViewCountRequest;
import com.testbed.web.api.dto.response.GetNftOneResponse;
import com.testbed.web.api.dto.response.MemberNftResponse;
import com.testbed.web.api.dto.response.MemberWalletResponses;
import com.testbed.web.api.dto.response.UpdateLikeCountResponse;
import com.testbed.web.api.service.ApiRestService;
import com.testbed.web.common.auth.MemberLoginManager;
import com.testbed.web.common.dto.NftCommentDto;
import com.testbed.web.common.dto.NftGalleryCommonDto;
import com.testbed.web.common.dto.NftPropertiesGroupDto;
...
import com.testbed.web.common.service.NftCommentService;
import com.testbed.web.common.service.NftFindService;
import com.testbed.web.gallery.service.GalleryService;
...
public class ApiRestController {
    ...
    public boolean saveEdit(@RequestParam(value = "sectionSeq") String sectionSeq, @RequestParam(value = "background", required = false) String background,@RequestParam(value = "nft[]") String[] nftList,@RequestParam(value = "frame[]", required = false) String[] frameList, @RequestParam(value = "orderSeq[]") String[] orderSeq) throws GeneralSecurityException, UnsupportedEncodingException {
        ...
        if(authDto.getLoginYN().equals("Y")) {
            ...
            resultFlag = apiRestService.saveMemberEdit(memberId, sectionSeq, background, nftList, frameList, orderSeq);
        }
