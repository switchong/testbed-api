...
import com.nftgram.api.domain.response.ListResult;
import com.nftgram.api.domain.response.SigleResult;
...
public class ResponseService {
    ...
    // 단일건 결과 처리 메소드
    public <T> SigleResult<T> getSignleResult(T data){
        SigleResult<T> result = new SigleResult<>();
        result.setData(data);
